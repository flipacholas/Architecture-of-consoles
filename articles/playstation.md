...
{{< float_block >}}
  ...
  <figcaption class="caption">Primitive view of the scene</figcaption>
{{< /float_block >}}
...
{{< float_block >}}
  {{< linked_img src="spyro/result.png" alt="Textures" >}}
...
{{< float_block >}}
  ...
  <br>Hence its camera only moves backwards or forwards
...
Like any other optical media, in order to fetch data from a CD, a laser beam is used to read the **pits** (zeroes) and **lands** (ones) from the track of the disc.
