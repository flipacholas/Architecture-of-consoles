...
Nintendo refers to them as **System updates**. They contain the two OSes the same package and use ordinal numbers for versioning. The last version known is `4.3E`, released in June 2010.
