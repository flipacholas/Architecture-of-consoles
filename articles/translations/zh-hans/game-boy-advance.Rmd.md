...
尽管GBA只有两个PCM通道，但一些游戏似乎能够“同时”播放两个以上的采样。 它是如何实现的？ 尽管GBA只有两个PCM通道，但有些游戏却能神奇地同时播放两个以上的采样。这怎么可能呢？虽然只有两个通道在纸面上看起来有点弱，但主CPU可以使用其部分周期来提供音频排序和混音[@audio-programming]（这应该能让你了解 ARM7 有多强大！）。 此外，在“操作系统”部分，你会发现BIOS ROM中包含了音频编曲器！
