...
从理论上讲，Z80的内存映射表明，Z80是**唯一**能够控制这两块芯片的CPU（这对于68000来说可能是个解脱，因为它已经忙于处理其他任务了）。 然而，在实际情况中，Z80可以关闭，因此68000可以访问YM2612（但不能访问SN76489）[@audio-68kym]。 因此，为了简单起见，在本文中，我们将假设音频任务被指定为Z80。
