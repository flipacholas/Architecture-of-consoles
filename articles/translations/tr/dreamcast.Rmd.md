...
Dreamcast’in bir diğer yenilikçi özelliği de **Visual Memory Unit** ya da ‘VMU’ idi. Kontrol cihazına takılıdır ve bir bellek kartı olarak hizmet etmenin yanı sıra, [@games-vmu] içeren tam teşekküllü bir cihazdır:
