...
- **Прямоугольники** также быстрее в отрисовке, но могут уместить только [спрайт](nes#tab-5-3-sprite-layer) размером до 256 x 256 пикселей (увеличение размера приведёт к дублированию рисунка спрайта). Тем более они не предоставляют [аффинные преобразования](super-nintendo#that-feature) (кроме отражения по осям X/Y), затенения или эффектов. Подозреваю, что это сделали для содействия в разработке 2D игр.
