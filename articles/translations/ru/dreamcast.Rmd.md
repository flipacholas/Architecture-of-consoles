...
- **Двунаправленный суперскалярный** конвейер: Новая разновидность параллелизма, когда процессор может обрабатывать более одной инструкции за раз (в нашем случае две) на каждом этапе конвейера. Это позволяет выполнять больше инструкций в секунду.
