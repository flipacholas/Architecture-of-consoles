...
![Обзор конвейера RSX.](gpu/pipeline.png)
...
![Как и в PSP, выбор игры в меню может стилизовать фон, чтобы привлечь ваше внимание!](xmb/game.jpg){.tabs-nested .active title="Игра"}

![XMB предоставляет огромное количество настроек. Это особенно полезно тогда, когда вам нужно настроить новый блестящий 1080p ТВ с объёмным 3.1-аудио.](xmb/settings.jpg){.tab-nested title="Настройки"}

![Различные мультимедиа-возможности.](xmb/multimedia.jpg){.tab-nested title="Мультимедиа"}

![XMB может устанавливать игры, обновления и дополнения (DLC) с помощью встроенного инсталлятора.](xmb/installpkg.jpg){.tabs-nested-last title="Установка"}

Наконец, добавление жесткого диска - это облегчение для ветеранов, которые в прошлом были вынуждены покупать дорогие проприетарные накопители ([Memory Stick Pro Duo](playstation-portable#tab-5-2-memory-stick-duo)), когда у них заканчивалось место.
...
Новое поколение = новый носитель. По мере того, как преимущества DVD начинают иссякать, а его ограничения, выраженные игровой индустрией (предел пространства) и киноиндустрией (формат 480i) [@games-dvd] становятся всё более очевидными, то это вопрос времени, когда Sony представит [другой стандарт](playstation-portable#tab-5-1-umd-discs) для замены своих новых устройств. Для этой новой консоли был выбран диск **Blu-Ray**.
...
- Игры должны обращаться к ядру для доступа к железу, которое, в свою очередь, обращается к **гипервизору**. Этот "лук абстракции" не позволяет [игровым эксплойтам](playstation-portable#tab-8-1-early-blunders) повышать привилегии, _теоретически_.
...
Аналогично событиям, произошедшим после появления [CFW](playstation-portable#tab-8-4-cfw-and-beyond) для PSP, Sony ответила двумя обновлениями системы безопасности:
