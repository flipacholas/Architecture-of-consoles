...
Во-вторых, в этой консоли установлен еще один процессор, **Zilog Z80**, работающий на частоте **~3,5 МГц**. Это тот же самый процессор, который был анализирован в [статье про Master System](master-system#cpu).
