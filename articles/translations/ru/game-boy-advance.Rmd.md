...
- **Функции разжатия данных**: Реализует алгоритмы распаковки, такие как кодирование длин серий (run-length encoding, RLE), LZ77 и алгоритм Хаффмана. Он также обеспечивает распаковку битов и последовательное различие.
