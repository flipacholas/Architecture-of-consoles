...
- Nintendo, **Revolution Transition Guide**
- bushing and marcan, [**25c3: Console Hacking 2008: Wii Fail**](https://www.youtube.com/watch?v=0rjaiNIc4W8).
  - Ben “bushing” Byer, one of the leading people in the Wii hacking scene, sadly [passed away](https://hackmii.com/ben) in 2016.

#### CPU

- IBM, **PowerPC 750CL RISC Microprocessor User’s Manual**
- IBM, **Broadway RISC Microprocessor User’s Manual**, Version 1.0
- Shank, [**Shank's Wii Super Thread** (Motherboard Revisions)](https://bitbuilt.net/forums/index.php?threads/shanks-wii-super-thread.66/)

#### Graphics

- WiiBrew, [**Video output**](https://wiibrew.org/wiki/Video_output)
- dolphin-emu.org, [**Myth Debugging: Is the Wii More Demanding to Emulate than the GameCube?**](https://dolphin-emu.org/blog/2018/07/21/myth-debugging-wii-more-demanding-emulate-gamecube/)

#### I/O

- WiiBrew, [**Wiimote**](http://wiibrew.org/wiki/Wiimote)

#### Operating System

- bushing, [**IOS: history, build process**](https://hackmii.com/2009/06/ios-history-build-process/)
- WiiBrew, [**Memory map**](https://wiibrew.org/wiki/Memory_Map)
- WiiBrew, [**Boot Process**](https://wiibrew.org/wiki/Boot_process)

#### Games

- RGDWiki, [**NDEV**](https://wiki.raregamingdump.ca/index.php/NDEV)
- RGDWiki, [**Revolution SDK**](https://wiki.mariocube.xyz/index.php/Revolution_SDK)
- Nintendo, **Wii Programming guidelines**, Version 1.10

#### Security

- WiiBrew, [**Disc Drive**](https://wiibrew.org/wiki/Hardware/Disc_Drive)
- WiiBrew, [**Wii Security**](https://wiibrew.org/wiki/Wii_Security)
- bushing, [**Keys, keys, keys.**](https://hackmii.com/2008/04/keys-keys-keys/)
- WiiBrew, [**Certificate chain structure**](https://wiibrew.org/wiki/Certificate_chain)
