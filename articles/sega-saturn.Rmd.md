...
- **16 general-purpose 32-bit registers**, which is double the amount of previous CPUs like the [Motorolla 68000](mega-drive-genesis#cpu). This is another design decision derived from the RISC guidelines [@cpu-patterson].
