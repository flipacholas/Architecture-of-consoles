...
Without further ado, here is the how the boot chain works, the starting point being the boot ROM [@operating_system-boot_process] [@operating_system-kernel_boot]:
